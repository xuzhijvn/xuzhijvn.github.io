...
![JDK1.7之前](https://picgo.6and.ltd/img/20201126173632432.png)

### JDK1.7

  在jdk1.7中，字符串常量池移到了堆中，运行时常量池还在方法区中。
![JDK1.7](https://picgo.6and.ltd/img/20201126173618236.png)

### JDK1.8

  jdk1.8删除了永久代，方法区这个概念还是保留的，但是方法区的实现变成了`元空间`，常量池沿用jdk1.7，还是放在了堆中。这样的效果就变成了：常量池和静态变量存储到了堆中，类的元数据及运行时常量池存储到元空间中。
![JDK1.8](https://picgo.6and.ltd/img/20201126172724596.png)
...
![在这里插入图片描述](https://picgo.6and.ltd/img/20201130112956433.png)
